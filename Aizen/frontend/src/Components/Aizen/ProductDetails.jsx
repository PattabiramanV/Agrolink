...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/controller/product.php?id=${id}`);
    ...
    const fetchSubcategoryProducts = async (subcategoryId) => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/controller/subcategory_products.php?subcategory_id=${subcategoryId}`);
        if (response.data && !response.data.error) {
    ...
    const checkAuth = async () => {
      ...
      if (token) {
        try {
          const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/controller/Admin/getUserDetails.php`, {
            headers: {
  ...
  const handleAddToCart = async () => {
    ...
    console.log(payload);
    try {
      const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/controller/cart.php`, payload, {
